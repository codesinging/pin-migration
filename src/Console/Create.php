...
class Create extends MigrationCommand
{
    /**
     * The command name.
     */
    const COMMAND_NAME = 'migrate:create';
    ...
    protected function configure()
    {
        $this->setName(self::COMMAND_NAME)
            ...
            ->addArgument('name', Argument::REQUIRED, 'What is the name of the migration (in CamelCase)?')
